...
export function Human(props) {
  ...
  const { animations: leftTurnAnimation } = useFBX("Animation/leftTurn.fbx");
  const { animations: standingAnimation } = useFBX("Animation/standing.fbx");
  const { animations: startWalkingAnimation } = useFBX(
    "Animation/startWalking.fbx"
  );
  ...
  startWalkingAnimation[0].name = "StartWalking";
